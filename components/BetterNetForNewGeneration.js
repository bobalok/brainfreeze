      ...
      <div className='text-center'>
        ...
        <div className='px-8 py-10'>
          ...
          <button>
            <Link
              href='/#pricing'
              className='shadow-lg bg-tatsuBTN2 hover:bg-transparent dark:text-white text-white transition-all ease-linear text-lg font-bold hover:text-textGray dark:hover:text-white py-4 px-4 border-2 bo border-transparent  hover:border-slate-400 rounded md:inline-flex flex items-center'>
              See pricing<svg
