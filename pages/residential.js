...
export default function residential() {
  return (
    <>
          ...
          <div className='max-w-2xl mx-auto'>
            ...
            <div className='py-8 sm:px-0 px-8'>
              <button>
                <Link
                  href=''
                  className="bg-transparent hover:bg-tatsuBTN2 dark:text-white text-textGray transition-all ease-linear text-base font-bold hover:text-white py-4 px-4 border-2 border-slate-400 hover:border-transparent rounded md:inline-flex flex items-center'"
                >
                  Subscribe Now
                  <svg
      ...
      <div className='h-max bg-gradient-to-tr from-rose-800 via-fuchsia-500 to-indigo-500 flex items-center text-thirdGray'>
        <div className='xl:max-w-5xl 2xl:max-w-7xl mx-auto px-4 md:py-16 sm:px-6 lg:px-8'>
          <div className='text-white'>
            <h1 className='text-3xl font-bold sm:text-5xl  pb-4 md:text-center mt-6'>
              Media Server You Deserve
            </h1>
            <p className='md:text-center max-w-xl mx-auto'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ipsum dolor sit amet,
            </p>
            <div className='pt-6 justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4'>
              ...
              <a className='w-full sm:w-auto md:flex bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700'>
                <svg
